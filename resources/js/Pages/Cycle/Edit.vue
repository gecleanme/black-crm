                            ...
                            <div class="lg:col-span-2">
                                ...
                                >
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        />
                                        <p
                                            v-if="formData.errors.premium"
                                            class="text-sm text-red-500 font-semibold"
                                        >
                                            {{ formData.errors.premium }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="md:col-span-3">
                                        ...
                                        <p
                                            v-if="formData.errors.vendor"
                                            class="text-sm text-red-500 font-semibold"
                                        >
                                            {{ formData.errors.vendor }}
                                        </p>
                                    </div>
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <p
                                            v-if="formData.errors.start_date"
                                            class="text-sm text-red-500 font-semibold"
                                        >
                                    ...
                                    <div class="md:col-span-6">
                                        ...
                                        >
                                            Attachments ({{
                                                cycle.attachments.length
                                            }})
                                        </label>

                                        <div
                                            class="flex flex-col w-full lg:flex-row my-2"
                                            v-for="attachment in cycle.attachments"
                                        >
                                            <div
                                            ...
                                            >
                                                <a
                                                    target="_blank"
                                                    :href="`${props.url}/storage/${attachment.attachments}`"
                                                    class="btn btn-ghost"
                                                    as="button"
                                                    >Preview</a
                                                >
                                ...
                                <div class="md:col-span-5 float-right">
                                    <div class="inline-flex items-end">
                                        <button
                                            ...
                                            class="bg-black hover:bg-gray-800 text-white font-bold py-2 px-4 rounded disabled:bg-opacity-40"
                                        >
                                            Update Cycle
                                        </button>
                                    </div>
