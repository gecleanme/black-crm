...
const sendData = () => formData.post('/customer/store',{
    ...
    <form @submit.prevent="sendData">
        ...
        <div class="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
            <div class="container max-w-screen-lg mx-auto">
                <div>
                    <h2 class="font-semibold text-xl text-gray-600">Add a Customer Profile</h2>
                            ...
                            <div class="lg:col-span-2">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 rounded-md border-white outline-white">
                                    ...
                                    <div class="md:col-span-5">
                                        ...
                                        <input type="text" v-model="formData.name" id="full_name" class="h-10 outline-white border border-gray-300 mt-1 rounded px-4 w-full"/>
                                        <p v-if="formData.errors.name" class="text-sm text-red-500 font-semibold">{{formData.errors.name}}</p>
                                    </div>

                                    <div class="md:col-span-5">
                                        <label for="full_name" class="font-semibold">Cell Phone</label>
                                        <input type="tel" v-model="formData.cell" id="full_name" class="h-10 outline-white border border-gray-300 mt-1 rounded px-4 w-full"/>
                                        <p v-if="formData.errors.cell" class="text-sm text-red-500 font-semibold">{{formData.errors.cell}}</p>
                                    </div>
                                    ...
                                    <div class="md:col-span-2 block border-r-2 ml-2 px-2">
                                        ...
                                        <label class="label cursor-pointer">
                                            ...
                                            <input type="radio" v-model="formData.type" class="bg-gray-100 checked: radio " value="Individual"  checked />
                                        </label>

                                        <label class="label cursor-pointer">
                                            <span class="label-text">Business</span>
                                            <input type="radio" v-model="formData.type" class="bg-gray-100 checked: radio " value="Business" />
                                        </label>
                                    ...
                                    <div class="md:col-span-2 block" v-show="formData.type === 'Individual'">
                                        ...
                                        <label class="label cursor-pointer">
                                            ...
                                            <input type="radio" v-model="formData.sex" class="bg-gray-100 checked: radio " value="Male"  checked />
                                        </label>

                                        <label class="label cursor-pointer">
                                            <span class="label-text">Female</span>
                                            <input type="radio" v-model="formData.sex" class="bg-gray-100 checked: radio " value="Female" />
                                        </label>
                                    ...
                                    <div class="md:col-span-6">
                                        ...
                                        <label for="risk_range" class="font-semibold">
                                            Risk Level
                                        </label>

                                        <input type="range" min="0" max="100"  class="range" step="25" v-model=formData.risk_level />
                                    ...
                                    <div class="md:col-span-5 text-right">
                                        <div class="inline-flex items-end">
                                            <button class="bg-black hover:bg-gray-800 text-white font-bold py-2 px-4 rounded">Create Profile</button>
                                        </div>
                                    </div>
