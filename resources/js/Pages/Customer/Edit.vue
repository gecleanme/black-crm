...
//create form and v-model the elements
    ...
    vip:props.customer.vip,
    cell:props.customer.cell ?? null,
    ...
    <form @submit.prevent="updateData">
        ...
        <div class="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
            <div class="container max-w-screen-lg mx-auto">
                <div>
                    <h2 class="font-semibold text-xl text-gray-600">Update Customer Profile</h2>
                                ...
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 rounded-md border-white outline-white">
                                    ...
                                    <div class="md:col-span-2 block border-r-2 ml-2 px-2">
                                        ...
                                        <label class="label cursor-pointer">
                                            ...
                                            <input type="radio" v-model="formData.type" class="bg-gray-100 checked: radio " value="Individual" />
                                        </label>
                                    ...
                                    <div class="md:col-span-2 block" v-show="formData.type === 'Individual'">
                                        ...
                                        <label class="label cursor-pointer">
                                            ...
                                            <input type="radio" v-model="formData.sex" class="bg-gray-100 checked: radio " value="Male" />
                                        </label>
                                    ...
                                    <div class="md:col-span-5 text-right">
                                        <div class="inline-flex items-end">
                                            <button class="bg-black hover:bg-gray-800 text-white font-bold py-2 px-4 rounded">Update Profile</button>
                                        </div>
                                    </div>
