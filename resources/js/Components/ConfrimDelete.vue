<template>
    ...
    <Dialog :open="isOpen" @close="setIsOpen">
        <DialogPanel class="fixed inset-0 flex justify-center items-center bg-gray-200 bg-opacity-50">
            <div class="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
                <DialogTitle class="text-lg font-bold mb-2">Delete Attachment?</DialogTitle>
                <DialogDescription class="text-sm text-gray-700 mb-4">
                </DialogDescription>

                <p class="text-center text-gray-700 mb-4">
                    Are you sure? Attachment will be
                    permanently removed. This action cannot be undone.
                </p>

                <div class="flex justify-center mt-4">
                    <!-- Cancel button -->
                    <button class="bg-white hover:bg-gray-100 text-gray-700 font-bold py-2 px-4 border border-gray-400 rounded shadow mr-2" @click="setIsOpen(false)">
                        Cancel
                    </button>

                    <!-- Delete button -->
                    <button class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded shadow" @click="handleDelete">
                        Delete
                    </button>
                </div>
            </div>
