<template>
    ...
    >
        <form
            ...
            class="flex flex-col items-center w-full px-4 py-8 rounded-lg shadow-md bg-gray-100"
        >
            <div class="flex flex-wrap justify-center gap-2 mb-8">
                <div class="flex flex-wrap gap-2 w-full sm:w-auto">
                    <select
                        class="w-full sm:w-40 px-5 py-3 text-gray-700 border border-gray-400 rounded-md appearance-none focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent"
                        v-model="props.type"
                    >
                    ...
                    <input
                        type="text"
                        class="w-full sm:w-auto px-3 py-2 text-gray-700 border border-gray-400 rounded-md appearance-none focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent"
